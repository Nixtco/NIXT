...
const SocialIcon: FC<{ path: string }> = ({ path }) => (
...
const Footer: FC = () => {
  ...
  const content = marketingContent[language].footer

  const socials = [
    { 
      name: 'GitHub', 
      href: 'https://github.com/nixtCo',
      ...
      <div className={styles.container}>
        ...
        <div className={styles.bottomSection}>
          <div className={styles.copyright}>
            © {currentYear} {content.copyrightSuffix}
          </div>
          <div className={styles.bottomLinks}>
            <a href="/privacy-policy" className={styles.bottomLink}>{content.privacy}</a>
            <a href="/terms-of-service" className={styles.bottomLink}>{content.terms}</a>
            {/* <a href="#" className={styles.bottomLink}>{content.sitemap}</a> */}
          </div>
        </div>
      </div>
    </footer>
