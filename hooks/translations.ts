  ...
  ar: {
    ...
    controllers: {
      ...
      finances: {
        ...
        addRefund: 'تسجيل إرجاع',
        selectProject: 'اختر المشروع',
        selectAdmin: 'اختر المسؤول',
        selectCategory: 'فئة المصروف',
        amount: 'المبلغ',
        date: 'التاريخ',
        ...
        noTransactions: 'لا توجد معاملات. ابدأ بإضافة معاملة جديدة.',
        customCategory: 'حدد الفئة',
        required: 'هذا الحقل مطلوب',
        saved: 'تم حفظ المعاملة بنجاح',
      ...
      chat: {
        title: 'المحادثات',
        subtitle: 'تابع رسائل العملاء ورد عليهم مباشرة',
        unread: 'غير مقروء',
  ...
  en: {
    ...
    controllers: {
      ...
      finances: {
        ...
        customCategory: 'Specify category',
      ...
      chat: {
        title: 'Messages',
        subtitle: 'Monitor client messages and reply directly',
        unread: 'Unread',
