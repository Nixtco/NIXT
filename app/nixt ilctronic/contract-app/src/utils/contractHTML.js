export function generateContractHTML({ clientName, clientEmail, projectDesc, contractNumber, formattedDate, year, theme }) {
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* === Frame with corners (matching CSS module exactly) === */
    .frame {
      position: absolute;
      top: 12mm;
      left: 12mm;
    ...
    .party-detail {
      font-size: 11px; color: #555; padding: 5px 0;
    ...
    /* === Intro === */
    .intro-text {
      font-size: 12px; color: #444; line-height: 2.1;
      margin: 15px 0; padding: 14px 16px;
      background: #fefdfb; border-radius: 8px; border: 1px solid #f0ebe0;
    }
    ...
    .finance-table td {
      ...
      border-bottom: 1px solid #f0ebe0; background: #fefdfb;
    }
    ...
    .total-row td {
      background: linear-gradient(135deg, #fdf6e3, #fff9ed) !important;
      font-weight: 800 !important; font-size: 14px !important; color: #1a1a2e;
    ...
    .sig-area {
      ...
      margin-bottom: 8px; background: #fefcf6;
    }
    .stamp {
      border: 2px solid ${accent};
      padding: 8px 25px;
    ...
    .footer-section {
      ...
      border-top: 2px solid ${accent}; text-align: center;
    }
    ...
    @media print {
      body { background: #fff; }
      .page { width: 100%; padding: 14mm 16mm; }
      .frame { top: 8mm; left: 8mm; right: 8mm; bottom: 8mm; }
    }
  </style>
</head>
<body>
  <div class="page">
    <!-- Golden Frame with Corners -->
    <div class="frame">
    ...
    <div class="header">
      ...
      <div class="meta-bar">
        ...
        <div class="meta-item">
          ...
          <span class="meta-value meta-gold">$450</span>
        </div>
      </div>
    </div>
    ...
    <table class="finance-table">
      ...
      <tbody>
        ...
        <tr>
          <td class="sub-item">↩ الدفعة الأولى (عند التوقيع - 50%)</td>
          <td class="amount sub-amount">$225.00</td>
        </tr>
        <tr>
          <td class="sub-item">↩ الدفعة الثانية (عند التسليم - 50%)</td>
          <td class="amount sub-amount">$225.00</td>
        </tr>
        <tr class="total-row">
          <td>الإجمالي المستحق</td>
          <td class="amount total-amount">$450.00</td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="signatures">
      ...
      <div class="sig-box">
        ...
        <div class="sig-area">
          <div class="sig-client">${clientName || ''}</div>
        </div>
